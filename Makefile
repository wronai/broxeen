...
test-docker: ## Run tests in Docker
	docker compose --profile test run --rm chatbrowse-test

dev: ## Start development server (hot reload)
	docker compose --profile dev up --build chatbrowse-dev

prod: ## Start production server
	docker compose up --build -d chatbrowse

build: ## Build Docker image
	docker compose build chatbrowse
