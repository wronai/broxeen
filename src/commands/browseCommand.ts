    ...
    try {
      ...
      this.eventStore.append({
        ...
        payload: {
          ...
          sitemapUrl: browseResult.sitemap_url,
          blogUrl: browseResult.blog_url,
          linkedinUrl: browseResult.linkedin_url,
          facebookUrl: browseResult.facebook_url,
          twitterUrl: browseResult.twitter_url,
          githubUrl: browseResult.github_url,
          youtubeUrl: browseResult.youtube_url,
          instagramUrl: browseResult.instagram_url,
        },
        timestamp: Date.now(),
      });
