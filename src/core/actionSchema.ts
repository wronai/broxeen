...
export const ACTION_SCHEMAS: readonly ActionSchema[] = [
  // ── Camera domain ────────────────────────────────
  {
    ...
    icon: '📷',
    keywords: ['kamera', 'widać', 'obraz', 'widzi', 'dzieje', 'podgląd', 'camera', 'describe', 'see'],
  ...
  },
  {
    ...
    icon: '📸',
    keywords: ['zdjęcie', 'snapshot', 'klatka', 'zrzut', 'capture', 'foto'],
  ...
  },
  {
    ...
    icon: '🩺',
    keywords: ['status', 'stan', 'zdrowie', 'health', 'działa', 'online', 'sprawdź'],
  ...
  },
  {
    ...
    icon: '🎮',
    keywords: ['obróć', 'przesuń', 'zoom', 'ptz', 'lewo', 'prawo', 'góra', 'dół', 'steruj'],
  ...
  },
  {
    ...
    icon: '🎥',
    keywords: ['live', 'rtsp', 'podgląd', 'na żywo', 'stream', 'preview'],
  ...
  },
  {
    ...
    icon: '🔎',
    keywords: ['onvif', 'odkryj', 'wykryj', 'kamery ip', 'discover'],
