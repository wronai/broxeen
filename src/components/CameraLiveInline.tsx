      ...
      {frame ? (
        <img
          ...
          className={
            ...
            "w-full h-auto object-contain max-h-96 rounded cursor-pointer hover:opacity-90 transition-opacity"
          }
          onClick={() => props.onClickImage?.(frame)}
        />
      ) : (
        <div className="w-full max-h-96 h-48 rounded bg-black/40 border border-gray-700 flex items-center justify-center text-gray-400 text-sm">
          Ładowanie klatki...
        </div>
      )}
    </div>
